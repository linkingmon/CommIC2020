...
#set DESIGN "alu"
read_verilog ../02_SYN/Netlist/FFT_SYN.v
current_design FFT
link

#read_sdc Lab4_alu.sdc
read_sdf -load_delay net ../02_SYN/Netlist/FFT_SYN.sdf

#======================================================
#  4. Read Switching Activity File
#======================================================
read_vcd -strip_path TESTBED/FFT_CORE ../03_GATESIM/FFT_GATE.vcd
